...
if ( defined( 'ABSPATH' ) ) {
	...
	define( 'GTM_MULTISITE_ADMIN_VERSION', '0.0.6' );
...
class GTM_Multisite_Admin {
	...
	function gtm_multisite_admin_scripts() {
		...
		wp_enqueue_script( 'change_gtm_id', $url . '/js/gtm-multisite-admin.js', array( 'jquery', 'jquery-effects-core' ), GTM_MULTISITE_ADMIN_VERSION );
